	...
	public static partial class Draw
	{
		...
		public static void Arrow(Vector2 start, Vector2 end, float thickness, float headLength, float headAngleDeg, Color col, float t = 1)
		{
			...
			if (headAngleDeg < 90)
			{
				...
				float l = (animEnd - start).magnitude;
				headAngleDeg *= Maths.EaseQuadInOut(l * 10);
				headLength *= Maths.EaseQuadInOut(l * 10);
			}
		...
		public static void DottedDataLine(float[] yVals, float xStart, float xEnd, float yMul, float thickness, Color col, Color dotCol, float dotRad, float animT = 1)
		{
