...
namespace Seb.Helpers
{
	...
	public static class InputHelper
	{
		...
		public static bool IsMouseHeldButNotDownThisFrame(MouseButton button)
		{
			return IsMouseHeld(button) && !IsMouseDownThisFrame(button);
		}
		...
		{
			if (IsKeyDownThisFrame(KeyCode.Alpha0)) return 0;
			if (IsKeyDownThisFrame(KeyCode.Alpha1)) return 1;
			if (IsKeyDownThisFrame(KeyCode.Alpha2)) return 2;
			if (IsKeyDownThisFrame(KeyCode.Alpha3)) return 3;
			if (IsKeyDownThisFrame(KeyCode.Alpha4)) return 4;
			if (IsKeyDownThisFrame(KeyCode.Alpha5)) return 5;
			if (IsKeyDownThisFrame(KeyCode.Alpha6)) return 6;
			if (IsKeyDownThisFrame(KeyCode.Alpha7)) return 7;
			if (IsKeyDownThisFrame(KeyCode.Alpha8)) return 8;
			if (IsKeyDownThisFrame(KeyCode.Alpha9)) return 9;
		...
		{
			if (IsKeyHeld(KeyCode.Alpha0)) return 0;
			if (IsKeyHeld(KeyCode.Alpha1)) return 1;
			if (IsKeyHeld(KeyCode.Alpha2)) return 2;
			if (IsKeyHeld(KeyCode.Alpha3)) return 3;
			if (IsKeyHeld(KeyCode.Alpha4)) return 4;
			if (IsKeyHeld(KeyCode.Alpha5)) return 5;
			if (IsKeyHeld(KeyCode.Alpha6)) return 6;
			if (IsKeyHeld(KeyCode.Alpha7)) return 7;
			if (IsKeyHeld(KeyCode.Alpha8)) return 8;
			if (IsKeyHeld(KeyCode.Alpha9)) return 9;
