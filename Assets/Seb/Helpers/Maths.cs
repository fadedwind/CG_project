...
namespace Seb.Helpers
{
	...
	public static class Maths
	{
		...
		public static float SampleBilinear(float[,] map, float u, float v, bool wrap = false, bool debug = false)
		{
			...
			if (debug)
			{
				Debug.Log(x + ", " + y + "  : uv = " + xFrac + ", " + yFrac + " ----------- uv in: " + u + ", " + v);
			}
